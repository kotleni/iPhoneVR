...
struct FFR {
    ...
    public static func calculateFoveationVars(_ body: StreamingStarted_Body) -> FoveationVars {
        let data: AlvrStreamConfig = .createDefault(body)
        ...
        return FoveationVars(
            ...
            targetEyeWidth: body.view_width,
            targetEyeHeight: body.view_height,
